...
Implementa el **algoritmo de Havel-Hakimi** para determinar si una secuencia de grados es gráfica (es decir, si corresponde a un grafo simple válido) y, de serlo, construye dicho grafo.
...
Para determinar si una arista es un **puente** (es decir, si su eliminación dividiría el grafo en dos componentes), se realiza una búsqueda en profundidad (DFS) desde uno de sus extremos y se verifica si el otro extremo sigue siendo alcanzable.
